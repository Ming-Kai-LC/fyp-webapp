...
class XRayImage(models.Model):
    ...
    notes = models.TextField(
        blank=True,
        help_text="Clinical notes or observations"
    )
...
class Prediction(models.Model):
    ...
    crossvit_prediction = models.CharField(
        max_length=50,
        help_text="CrossViT model prediction"
    )
    ...
    doctor_notes = models.TextField(
        blank=True,
        help_text="Doctor's clinical assessment and notes"
    )
    ...
    def get_all_predictions(self):
        ...
        """
        return [
            {'model': 'CrossViT', 'prediction': self.crossvit_prediction, 'confidence': self.crossvit_confidence},
            {'model': 'ResNet-50', 'prediction': self.resnet50_prediction, 'confidence': self.resnet50_confidence},
            {'model': 'DenseNet-121', 'prediction': self.densenet121_prediction, 'confidence': self.densenet121_confidence},
            {'model': 'EfficientNet-B0', 'prediction': self.efficientnet_prediction, 'confidence': self.efficientnet_confidence},
            {'model': 'ViT-Base', 'prediction': self.vit_prediction, 'confidence': self.vit_confidence},
            {'model': 'Swin-Tiny', 'prediction': self.swin_prediction, 'confidence': self.swin_confidence},
        ]
